...
A modern, responsive, and light-weight web application designed for managing and tracking internal PUBG Mobile esports tournaments. It automatically calculates team rankings using the official PMGC point system, tracks individual player statistics, and highlights the overall tournament MVP.
...
### Prerequisites
No complex backend setup or node dependencies are required. This application runs directly in any modern web browser.
